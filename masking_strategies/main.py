...
def main():
    ...
    results_df = results_df[
        ["Dataset", "Masking Strategy"] + [col for col in results_df.columns if col not in ["Dataset", "Masking Strategy"]]]
    results_df.sort_values(["Dataset", "Masking Strategy"], inplace=True)
