...
def main():
    ...
    results_df = results_df[
        ["Dataset", "Batch Selection Strategy"] + [col for col in results_df.columns if col not in ["Dataset", "Batch Selection Strategy"]]]
    results_df.sort_values(["Dataset", "Batch Selection Strategy"], inplace=True)
